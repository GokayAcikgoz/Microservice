...
namespace Microservice.Shared
{
    ...
    {
        [JsonIgnore] //response modelde gözükmesini istemediğimiz için
        public HttpStatusCode Status { get; set; }

        //.NetCore olarak kullanacağız o yüzden referance verecez onu. Refit kullanmıyoruz onu
        ...
        public static ServiceResult ErrorFromProblemDerails(ApiException exception)
        {
    ...
    public class ServiceResult<T> : ServiceResult
    {
        ...
        //200
        public static ServiceResult<T> SuccessAsOkey(T data)
        {
        ...
        //201 => created response body header => location  => api/products/1
        ...
        public new static ServiceResult<T> ErrorFromProblemDerails(ApiException exception)
        {
            if (string.IsNullOrEmpty(exception.Content))
            {
                return new ServiceResult<T>
